using System;
using San.SimpleChat.DependencyResolver;
using San.SimpleChat.DataRepositories.Context;
...
using San.SimpleChat.Core.AppSetting;
using System.Text;
using San.SimpleChat.Core.Entities;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.IdentityModel.Tokens;
using San.SimpleChat.API.Hubs;
using Microsoft.AspNetCore.Http.Connections;
using Autofac;
using Autofac.Extensions.DependencyInjection;

namespace San.SimpleChat
{
